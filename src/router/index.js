...
export const constantRoutes = [
  ...
  },
  {
    ...
    children: [{
      ...
      meta: { title: '项目信息', keepAlive: true, affix: true }
    }, {
      path: 'staff',
      name: 'Staff',
      ...
      meta: { title: '项目详细信息', keepAlive: true, activeMenu: '/projectInformation/list' }
    }, {
      path: 'single-info',
      name: 'SingleInfo',
      hidden: true,
      component: () => import('@/views/projectInformation/singleInfo'),
      meta: { title: '单体建筑信息', keepAlive: true, activeMenu: '/projectInformation/list' }
    }, {
      path: 'single-detail',
      name: 'SingleDetail',
      hidden: true,
